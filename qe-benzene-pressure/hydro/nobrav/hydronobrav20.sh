...
cat >   hydronobrav20.in  << EOF 
&CONTROL
  calculation = 'vc-relax'
  etot_conv_thr =   5.000000000d-05
  forc_conv_thr =   1.0000000000d-04
  outdir = './out/'
  prefix = 'hydronobrav20'
...
CELL_PARAMETERS alat
   ...
   0.000000000   0.998189860   0.000000000
  -0.386260298   0.000000000   1.318109975
...
$PW_COMMAND < hydronobrav20.in > hydronobrav20.out
$ECHO " done"
