...
cat >   hydronobrav30.in  << EOF 
&CONTROL
  calculation = 'vc-relax'
  etot_conv_thr =   5.000000000d-05
  forc_conv_thr =   1.0000000000d-04
  outdir = './out/'
  prefix = 'hydronobrav30'
...
CELL_PARAMETERS alat
   0.997461611   0.000000000   0.000000000
   0.000000000   0.997946289   0.000000000
  -0.362107026   0.000000000   1.311927626
...
$PW_COMMAND < hydronobrav30.in > hydronobrav30.out
$ECHO " done"
