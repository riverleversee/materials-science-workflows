...
cat >   hydronobrav15.in  << EOF 
&CONTROL
  calculation = 'vc-relax'
  etot_conv_thr =   5.000000000d-05
  forc_conv_thr =   1.0000000000d-04
  outdir = './out/'
  prefix = 'hydronobrav15'
...
CELL_PARAMETERS alat
   ...
   0.000000000   0.997637280   0.000000000
  -0.400019849   0.000000000   1.316982941
...
$PW_COMMAND < hydronobrav15.in > hydronobrav15.out
$ECHO " done"
