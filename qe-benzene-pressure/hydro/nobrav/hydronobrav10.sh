...
cat >   hydronobrav10.in  << EOF 
&CONTROL
  calculation = 'vc-relax'
  etot_conv_thr =   5.000000000d-05
  forc_conv_thr =   1.0000000000d-04
  outdir = './out/'
  prefix = 'hydronobrav10'
...
CELL_PARAMETERS alat
   1.005428671   0.000000000   0.000000000
   0.000000000   1.002066932   0.000000000
  -0.419036094   0.000000000   1.322182735
...
$PW_COMMAND < hydronobrav10.in > hydronobrav10.out
$ECHO " done"
